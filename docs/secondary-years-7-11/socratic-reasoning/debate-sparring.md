...
# Socratic Sparring Arena ⚔️

Stress-test hypotheses, dissect historical policies, and evaluate ethical trade-offs.
...
<div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '15px' }}>
  <button onClick={() => window.askSchoolAI('debate-partner', 'Take a contrarian view: Argue why space exploration funding should be diverted entirely to ocean conservation.')} style={{ background: '#e11d48', color: '#fff', border: 'none', padding: '10px 18px', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold' }}>🚀 Space vs Ocean Conservation</button>
  <button onClick={() => window.askSchoolAI('debate-partner', 'Challenge the idea that autonomous vehicles are ready for public roads. Focus on edge-case ethical decisions.')} style={{ background: '#ea580c', color: '#fff', border: 'none', padding: '10px 18px', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold' }}>🚗 Autonomous Vehicle Ethics</button>
</div>

<div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
  <input type="text" id="custom-prompt-input" placeholder="State your thesis or counter-argument..." style={{ flexGrow: 1, padding: '12px 14px', borderRadius: '6px', border: '1px solid #334155', background: '#0f172a', color: '#f8fafc' }} />
  <button onClick={() => { const input = document.getElementById('custom-prompt-input'); if(input && input.value) window.askSchoolAI('debate-partner', input.value); }} style={{ background: '#16a34a', color: '#fff', border: 'none', padding: '0 20px', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold' }}>Debate AI 🚀</button>
</div>
...
<div id="ai-output-box" style={{ background: '#030712', border: '1px solid #1f2937', borderRadius: '8px', padding: '18px', minHeight: '110px', fontFamily: 'monospace', color: '#4ade80', whiteSpace: 'pre-wrap', lineHeight: 1.6 }}>
  Ready. Select a debate prompt or present your thesis above.
</div>
