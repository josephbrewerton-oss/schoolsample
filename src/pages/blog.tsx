...
export default function BlogPage(): React.JSX.Element {
  return (
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '2.5rem 1.25rem 4rem' }}>
      ...
      >
        <p style={{ fontSize: '1.15rem', color: '#1e293b', fontWeight: 500, marginBottom: '1.75rem' }}>
        ...
        <h2 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#0f172a', marginTop: '2rem', marginBottom: '0.75rem' }}>
